<div>
    ...
    <x-table-form>
        ...
        @endslot
        @slot('paginate')
            {{ $schedules->links('vendor.livewire.custom') }}
        @endslot
    </x-table-form>
