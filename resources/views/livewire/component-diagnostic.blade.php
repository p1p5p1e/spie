            ...
            <form class="mt-2">
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 mb-6 w-full group">
                        <label for="indicator" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">
                            {{ __('Indicator') }}
                        </label>
                        <textarea id="indicator" wire:model='indicator' rows="4"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder=""></textarea>
                        <x-jet-input-error for="indicator" />
                    </div>
                        ...
                        @foreach ($diagnostics as $diagnostic)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="py-4 px-6 text-right">
                                    <ul>
                                        <li>
                                            <a href="{{ route('page.record', $diagnostic) }}"
                                                class="font-medium text-blue-600 dark:text-blue-500 hover:underline cursor-pointer">{{ __('Record') }}</a>
                                        </li>
                                    </ul>
                                </td>
                            </tr>
