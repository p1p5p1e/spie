<div>
        ...
        @slot('form')
            <form class="mt-2">
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="number" step="0.01" name="budget" id="budget" wire:model='budget'
                ...
                <div class="grid grid-cols-1 sm:grid-cols-12 gap-2">
                    @if ($activity == 'create')
                        ...
                        @if ($visibility)
                            <a wire:click='generate' wire:loading.attr="disabled" wire:target="generate"
                                class="col-span-1 sm:col-span-2 text-white bg-orange-700 hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800 cursor-pointer disabled:opacity-25 transition">
                                {{ __('Generate') }}
                            </a>
                        @endif
                    @endif
    ...
    <x-table-form>
        ...
        @endslot
        @slot('paginate')
            {{ $consolidateds->links('vendor.livewire.custom') }}
        @endslot
    </x-table-form>
