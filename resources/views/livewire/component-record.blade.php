<div>
        ...
        @slot('form')
            <form class="mt-2">
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="number" step="0.01" name="worth" id="worth" wire:model='worth'
    ...
    <x-table-form>
        ...
        @endslot
        @slot('paginate')
            {{ $records->links('vendor.livewire.custom') }}
        @endslot
    </x-table-form>
